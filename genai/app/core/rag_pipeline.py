...
class RAGSystem:
    ...
    def __init__(self, llm: BaseChatModel = None, retriever: BaseRetriever = None):
        ...
        self.rag_chain = (
            RunnableParallel(
                context=(lambda x: x['question']) | self.retriever, # Pass question to retriever for context
...
# Example:
# rag_system_instance: RAGSystem = None
#
...
if __name__ == '__main__':
    ...
    class MockRetriever(BaseRetriever):
        ...
        async def _aget_relevant_documents(self, query: str, *, run_manager=None) -> List[Document]:
            ...
            if "AVL tree" in query.lower():
                return [
                    Document(page_content="AVL trees are self-balancing binary search trees. Rotations (like left and right rotations) are key operations to maintain their balance property after node insertions or deletions."),
