...
class ChatService:
    def __init__(self, rag_system_instance: Optional[RAGSystem] = None):
        ...
        try:
            ...
            # This service is unusable without RAG. Re-raise or handle
            # appropriately.
    ...
    async def process_chat_query(
        ...
        if not self.rag_system:
            # This check is somewhat redundant due to __init__ raising error,
            # but good for safety.
...
def get_chat_service_instance() -> ChatService:
    ...
    if chat_service_instance is None:
        # This ensures that RAG system (and its dependencies like LLM) are
        # initialized first
        try:
            # RAGSystem's constructor will call get_llm_instance and
            # get_retriever
...
if __name__ == "__main__":
    ...
    from unittest.mock import patch  # For mocking async methods
    ...
    async def main_chat_test():
        ...
        with patch("app.core.rag_pipeline.get_retriever", return_value=mock_retriever_instance):
            ...
            try:
                ...
                # Check if group-specific document was retrieved due to
                # group_id
